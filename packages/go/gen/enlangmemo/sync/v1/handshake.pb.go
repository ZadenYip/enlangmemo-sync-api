...
const (
	...
	HandshakeStatus_HANDSHAKE_STATUS_COLLECTION_ID_MISMATCH HandshakeStatus = 9
)
...
var (
	HandshakeStatus_name = map[int32]string{
		...
		9: "HANDSHAKE_STATUS_COLLECTION_ID_MISMATCH",
	}
...
const file_enlangmemo_sync_v1_handshake_proto_rawDesc = "" +
	...
	"$HANDSHAKE_STATUS_CLIENT_DATA_TOO_OLD\x10\b\x12+\n" +
	"'HANDSHAKE_STATUS_COLLECTION_ID_MISMATCH\x10\tB\xe5\x01\n" +
